-- Migration pour corriger les politiques de sécurité du bucket "albums"
...
-- Format du chemin: albums/{userId}-{timestamp}.{ext}
CREATE POLICY "Authenticated users can upload albums"
